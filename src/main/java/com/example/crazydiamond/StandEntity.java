 ...
 * and the current animation id (via the data tracker).
 */
public class StandEntity extends Entity {
	...
	public void tick() {
		...
		PlayerEntity found = ownerUuid == null ? null : world.getPlayerByUuid(ownerUuid);
	...
	private void follow(ServerPlayerEntity owner) {
		...
		double bob = Math.sin(this.age * 0.12) * 0.08;
